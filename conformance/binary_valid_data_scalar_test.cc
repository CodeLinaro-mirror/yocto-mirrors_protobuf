...
TEST_P(ValidDataScalarTest, Scalar) {
  EXPECT_THAT(RequiredTest(TestName("ValidDataScalar"))
...
TEST_P(ValidDataScalarTest, ScalarBinary) {
  EXPECT_THAT(RecommendedTest(TestName("ValidDataScalarBinary"))
                  .ParseBinary(message(), FieldWithValue(value().input))
                  .SerializeBinary(),
...
TEST_P(RepeatedScalarSelectsLastTest, SelectsLast) {
  ...
  EXPECT_THAT(RequiredTest(TestName("RepeatedScalarSelectsLast"))
