...
//
// The legacy suite ran RunAllTests() only for TestAllTypesProto3, which
// RunSuiteImpl() instantiates in its proto3 and editions flavours, so these
...
TEST_P(TextIntegerTest, Int32FieldMaxValue) {
  EXPECT_THAT(
      RequiredTest("Int32FieldMaxValue")
...
TEST_P(TextIntegerTest, Int32FieldMinValue) {
  EXPECT_THAT(
      RequiredTest("Int32FieldMinValue")
...
TEST_P(TextIntegerTest, Uint32FieldMaxValue) {
  EXPECT_THAT(
      RequiredTest("Uint32FieldMaxValue")
...
TEST_P(TextIntegerTest, Int32FieldMaxValueHex) {
  EXPECT_THAT(
      RequiredTest("Int32FieldMaxValueHex")
...
TEST_P(TextIntegerTest, Int32FieldMinValueHex) {
  EXPECT_THAT(
      RequiredTest("Int32FieldMinValueHex")
...
TEST_P(TextIntegerTest, Uint32FieldMaxValueHex) {
  EXPECT_THAT(
      RequiredTest("Uint32FieldMaxValueHex")
...
TEST_P(TextIntegerTest, Int64FieldMaxValueHex) {
  EXPECT_THAT(RequiredTest("Int64FieldMaxValueHex")
...
TEST_P(TextIntegerTest, Int64FieldMinValueHex) {
  EXPECT_THAT(RequiredTest("Int64FieldMinValueHex")
...
TEST_P(TextIntegerTest, Uint64FieldMaxValueHex) {
  EXPECT_THAT(RequiredTest("Uint64FieldMaxValueHex")
...
TEST_P(TextIntegerTest, Int32FieldMaxValueOctal) {
  EXPECT_THAT(
      RequiredTest("Int32FieldMaxValueOctal")
...
TEST_P(TextIntegerTest, Int32FieldMinValueOctal) {
  EXPECT_THAT(
      RequiredTest("Int32FieldMinValueOctal")
...
TEST_P(TextIntegerTest, Uint32FieldMaxValueOctal) {
  EXPECT_THAT(
      RequiredTest("Uint32FieldMaxValueOctal")
...
TEST_P(TextIntegerTest, Int64FieldMaxValueOctal) {
  EXPECT_THAT(
      RequiredTest("Int64FieldMaxValueOctal")
...
TEST_P(TextIntegerTest, Int64FieldMinValueOctal) {
  EXPECT_THAT(
      RequiredTest("Int64FieldMinValueOctal")
...
TEST_P(TextIntegerTest, Uint64FieldMaxValueOctal) {
  EXPECT_THAT(
      RequiredTest("Uint64FieldMaxValueOctal")
...
TEST_P(TextIntegerTest, Int64FieldTooLarge) {
  EXPECT_THAT(RequiredTest("Int64FieldTooLarge")
                  .ParseText(message(), "optional_int64: 9223372036854775808")
                  .ParseOnly(),
              Yields(IsParseError()));
}
...
TEST_P(TextIntegerTest, Int64FieldTooSmall) {
  EXPECT_THAT(RequiredTest("Int64FieldTooSmall")
...
TEST_P(TextIntegerTest, Uint64FieldTooLarge) {
  EXPECT_THAT(RequiredTest("Uint64FieldTooLarge")
...
TEST_P(TextIntegerTest, Int32FieldTooLargeHex) {
  EXPECT_THAT(RequiredTest("Int32FieldTooLargeHex")
                  .ParseText(message(), "optional_int32: 0x80000000")
                  .ParseOnly(),
              Yields(IsParseError()));
}
...
TEST_P(TextIntegerTest, Int32FieldTooSmallHex) {
  EXPECT_THAT(RequiredTest("Int32FieldTooSmallHex")
...
TEST_P(TextIntegerTest, Uint32FieldTooLargeHex) {
  EXPECT_THAT(RequiredTest("Uint32FieldTooLargeHex")
...
TEST_P(TextIntegerTest, Int64FieldTooLargeHex) {
  EXPECT_THAT(RequiredTest("Int64FieldTooLargeHex")
                  .ParseText(message(), "optional_int64: 0x8000000000000000")
                  .ParseOnly(),
              Yields(IsParseError()));
}
...
TEST_P(TextIntegerTest, Int64FieldTooSmallHex) {
  EXPECT_THAT(RequiredTest("Int64FieldTooSmallHex")
...
TEST_P(TextIntegerTest, Uint64FieldTooLargeHex) {
  EXPECT_THAT(RequiredTest("Uint64FieldTooLargeHex")
...
TEST_P(TextIntegerTest, Int32FieldTooLargeOctal) {
  EXPECT_THAT(RequiredTest("Int32FieldTooLargeOctal")
                  .ParseText(message(), "optional_int32: 020000000000")
                  .ParseOnly(),
              Yields(IsParseError()));
}
...
TEST_P(TextIntegerTest, Int32FieldTooSmallOctal) {
  EXPECT_THAT(RequiredTest("Int32FieldTooSmallOctal")
...
TEST_P(TextIntegerTest, Uint32FieldTooLargeOctal) {
  EXPECT_THAT(RequiredTest("Uint32FieldTooLargeOctal")
...
TEST_P(TextIntegerTest, Int64FieldTooLargeOctal) {
  EXPECT_THAT(
      RequiredTest("Int64FieldTooLargeOctal")
          .ParseText(message(), "optional_int64: 01000000000000000000000")
          .ParseOnly(),
      Yields(IsParseError()));
}
...
TEST_P(TextIntegerTest, Int64FieldTooSmallOctal) {
  EXPECT_THAT(
      RequiredTest("Int64FieldTooSmallOctal")
...
TEST_P(TextIntegerTest, Uint64FieldTooLargeOctal) {
  EXPECT_THAT(
      RequiredTest("Uint64FieldTooLargeOctal")
