...
//
// TODO: b/410121831 - The value table of the oneof valid-data group still
// lives in binary_json_conformance_suite.cc and moves here when that group
// migrates.
...
// (ValidDataMap.<KEY>.<VALUE>.*), in the legacy order.  The legacy
