...
TEST_P(JsonTimestampTest, TimestampMinValue) {
  ...
  EXPECT_THAT(RequiredTest("TimestampMinValue")
...
TEST_P(JsonTimestampTest, TimestampMaxValue) {
  ...
  EXPECT_THAT(RequiredTest("TimestampMaxValue")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("TimestampMaxValue")
...
TEST_P(JsonTimestampTest, TimestampRepeatedValue) {
  ...
  EXPECT_THAT(RequiredTest("TimestampRepeatedValue")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("TimestampRepeatedValue")
...
TEST_P(JsonTimestampTest, TimestampEpochValue) {
  ...
  EXPECT_THAT(RequiredTest("TimestampEpochValue")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("TimestampEpochValue")
...
TEST_P(JsonTimestampTest, TimestampNanoAfterEpochlValue) {
  ...
  EXPECT_THAT(RequiredTest("TimestampNanoAfterEpochlValue")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("TimestampNanoAfterEpochlValue")
...
TEST_P(JsonTimestampTest, TimestampNanoBeforeEpochValue) {
  ...
  EXPECT_THAT(RequiredTest("TimestampNanoBeforeEpochValue")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("TimestampNanoBeforeEpochValue")
...
TEST_P(JsonTimestampTest, TimestampLittleAfterEpochlValue) {
  ...
  EXPECT_THAT(RequiredTest("TimestampLittleAfterEpochlValue")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("TimestampLittleAfterEpochlValue")
...
TEST_P(JsonTimestampTest, TimestampLittleBeforeEpochValue) {
  ...
  EXPECT_THAT(RequiredTest("TimestampLittleBeforeEpochValue")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("TimestampLittleBeforeEpochValue")
...
TEST_P(JsonTimestampTest, TimestampTenAndHalfSecondsAfterEpochValue) {
  ...
  EXPECT_THAT(RequiredTest("TimestampTenAndHalfSecondsAfterEpochValue")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("TimestampTenAndHalfSecondsAfterEpochValue")
...
TEST_P(JsonTimestampTest, TimestampTenAndHalfSecondsBeforeEpochValue) {
  ...
  EXPECT_THAT(RequiredTest("TimestampTenAndHalfSecondsBeforeEpochValue")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("TimestampTenAndHalfSecondsBeforeEpochValue")
...
TEST_P(JsonTimestampTest, TimestampLeap) {
  ...
  EXPECT_THAT(RequiredTest("TimestampLeap")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("TimestampLeap")
...
TEST_P(JsonTimestampTest, TimestampWithPositiveOffset) {
  ...
  EXPECT_THAT(RequiredTest("TimestampWithPositiveOffset")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("TimestampWithPositiveOffset")
...
TEST_P(JsonTimestampTest, TimestampWithNegativeOffset) {
  ...
  constexpr absl::string_view kExpected = "optional_timestamp: {seconds: 1}";
  EXPECT_THAT(RequiredTest("TimestampWithNegativeOffset")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("TimestampWithNegativeOffset")
...
TEST_P(JsonTimestampTest, TimestampNull) {
  ...
  constexpr absl::string_view kExpected = "";
  EXPECT_THAT(RequiredTest("TimestampNull")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("TimestampNull")
...
TEST_P(JsonTimestampTest, TimestampJsonInputTooSmall) {
  EXPECT_THAT(RequiredTest("TimestampJsonInputTooSmall")
                  .ParseJson(message(),
...
TEST_P(JsonTimestampTest, TimestampJsonInputTooLarge) {
  EXPECT_THAT(
      RequiredTest("TimestampJsonInputTooLarge")
          .ParseJson(message(),
...
TEST_P(JsonTimestampTest, TimestampJsonInputMissingZ) {
  EXPECT_THAT(RequiredTest("TimestampJsonInputMissingZ")
                  .ParseJson(message(),
...
TEST_P(JsonTimestampTest, TimestampJsonInputMissingT) {
  EXPECT_THAT(RequiredTest("TimestampJsonInputMissingT")
                  .ParseJson(message(),
...
TEST_P(JsonTimestampTest, TimestampJsonInputLowercaseZ) {
  EXPECT_THAT(RequiredTest("TimestampJsonInputLowercaseZ")
                  .ParseJson(message(),
                             R"({"optionalTimestamp": "0001-01-01T00:00:00z"})")
                  .ParseOnly(),
              Yields(IsParseError()));
...
TEST_P(JsonTimestampTest, TimestampJsonInputLowercaseT) {
  EXPECT_THAT(RequiredTest("TimestampJsonInputLowercaseT")
                  .ParseJson(message(),
                             R"({"optionalTimestamp": "0001-01-01t00:00:00Z"})")
                  .ParseOnly(),
              Yields(IsParseError()));
...
TEST_P(JsonTimestampTest, TimestampWithMissingColonInOffset) {
  EXPECT_THAT(
      RequiredTest("TimestampWithMissingColonInOffset")
          .ParseJson(message(),
...
TEST_P(JsonTimestampTest, TimestampProtoInputTooSmall) {
  EXPECT_THAT(
      RequiredTest("TimestampProtoInputTooSmall")
          .ParseBinary(message(),
...
TEST_P(JsonTimestampTest, TimestampProtoInputTooLarge) {
  EXPECT_THAT(
      RequiredTest("TimestampProtoInputTooLarge")
          .ParseBinary(message(),
                       LengthPrefixedField(kOptionalTimestamp,
...
TEST_P(JsonTimestampTest, TimestampProtoNegativeNanos) {
  EXPECT_THAT(RequiredTest("TimestampProtoNegativeNanos")
...
TEST_P(JsonTimestampTest, TimestampProtoNanoTooLarge) {
  EXPECT_THAT(
      RequiredTest("TimestampProtoNanoTooLarge")
          .ParseBinary(message(), LengthPrefixedField(
                                      kOptionalTimestamp,
                                      Wire(VarintField(kSeconds, 5000),
...
TEST_P(JsonTimestampTest, TimestampZeroNormalized) {
  EXPECT_THAT(
      RecommendedTest("TimestampZeroNormalized")
          .ParseJson(message(),
...
TEST_P(JsonTimestampTest, TimestampHasZeroFractionalDigit) {
  EXPECT_THAT(
      RecommendedTest("TimestampHasZeroFractionalDigit")
          .ParseJson(
              message(),
...
TEST_P(JsonTimestampTest, TimestampHas3FractionalDigits) {
  EXPECT_THAT(
      RecommendedTest("TimestampHas3FractionalDigits")
          .ParseJson(
              message(),
...
TEST_P(JsonTimestampTest, TimestampHas6FractionalDigits) {
  EXPECT_THAT(
      RecommendedTest("TimestampHas6FractionalDigits")
          .ParseJson(
              message(),
...
TEST_P(JsonTimestampTest, TimestampHas9FractionalDigits) {
  EXPECT_THAT(
      RecommendedTest("TimestampHas9FractionalDigits")
          .ParseJson(
              message(),
...
TEST_P(JsonTimestampTest, TimestampJsonInputMonthTooLarge) {
  EXPECT_THAT(RequiredTest("TimestampJsonInputMonthTooLarge")
                  .ParseJson(message(),
...
TEST_P(JsonTimestampTest, TimestampJsonInputMonthZero) {
  EXPECT_THAT(RequiredTest("TimestampJsonInputMonthZero")
                  .ParseJson(message(),
...
TEST_P(JsonTimestampTest, TimestampJsonInputDayTooLarge) {
  EXPECT_THAT(RequiredTest("TimestampJsonInputDayTooLarge")
                  .ParseJson(message(),
...
TEST_P(JsonTimestampTest, TimestampJsonInputDayZero) {
  EXPECT_THAT(RequiredTest("TimestampJsonInputDayZero")
                  .ParseJson(message(),
...
TEST_P(JsonTimestampTest, TimestampJsonInputHourTooLarge) {
  EXPECT_THAT(RequiredTest("TimestampJsonInputHourTooLarge")
                  .ParseJson(message(),
...
TEST_P(JsonTimestampTest, TimestampJsonInputHourTooLarge25) {
  EXPECT_THAT(RequiredTest("TimestampJsonInputHourTooLarge25")
                  .ParseJson(message(),
...
TEST_P(JsonTimestampTest, TimestampJsonInputMinuteTooLarge) {
  EXPECT_THAT(RequiredTest("TimestampJsonInputMinuteTooLarge")
                  .ParseJson(message(),
...
TEST_P(JsonTimestampTest, TimestampJsonInputSecondTooLarge) {
  EXPECT_THAT(RequiredTest("TimestampJsonInputSecondTooLarge")
                  .ParseJson(message(),
...
TEST_P(JsonTimestampTest, TimestampJsonInputInvalidOffsetHour) {
  EXPECT_THAT(
      RequiredTest("TimestampJsonInputInvalidOffsetHour")
          .ParseJson(message(),
...
TEST_P(JsonTimestampTest, TimestampJsonInputInvalidOffsetMinute) {
  EXPECT_THAT(
      RequiredTest("TimestampJsonInputInvalidOffsetMinute")
          .ParseJson(message(),
...
TEST_P(JsonTimestampTest, TimestampJsonInputOffsetBoundaryUnderflow) {
  EXPECT_THAT(
      RequiredTest("TimestampJsonInputOffsetBoundaryUnderflow")
          .ParseJson(message(),
...
TEST_P(JsonTimestampTest, TimestampJsonInputOffsetBoundaryOverflow) {
  EXPECT_THAT(
      RequiredTest("TimestampJsonInputOffsetBoundaryOverflow")
          .ParseJson(message(),
...
TEST_P(JsonTimestampTest, TimestampJsonInputInvalidNanos) {
  EXPECT_THAT(
      RequiredTest("TimestampJsonInputInvalidNanos")
          .ParseJson(
              message(),
...
TEST_P(JsonTimestampTest, TimestampJsonInputInvalidCharsInNanos) {
  EXPECT_THAT(
      RequiredTest("TimestampJsonInputInvalidCharsInNanos")
          .ParseJson(message(),
...
TEST_P(JsonTimestampTest, TimestampJsonInputYearTooShort) {
  EXPECT_THAT(RequiredTest("TimestampJsonInputYearTooShort")
                  .ParseJson(message(),
...
TEST_P(JsonTimestampTest, TimestampJsonInputYearTooLong) {
  EXPECT_THAT(
      RequiredTest("TimestampJsonInputYearTooLong")
          .ParseJson(message(),
...
TEST_P(JsonTimestampTest, TimestampJsonInputMonthTooShort) {
  EXPECT_THAT(RequiredTest("TimestampJsonInputMonthTooShort")
                  .ParseJson(message(),
...
TEST_P(JsonTimestampTest, TimestampJsonInputDayTooShort) {
  EXPECT_THAT(RequiredTest("TimestampJsonInputDayTooShort")
                  .ParseJson(message(),
...
TEST_P(JsonTimestampTest, TimestampJsonInputNonLeapFeb29) {
  EXPECT_THAT(RequiredTest("TimestampJsonInputNonLeapFeb29")
                  .ParseJson(message(),
...
TEST_P(JsonTimestampTest, TimestampJsonInputLeapFeb29) {
  ...
  EXPECT_THAT(RequiredTest("TimestampJsonInputLeapFeb29")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("TimestampJsonInputLeapFeb29")
...
TEST_P(JsonTimestampTest, TimestampWithOffsetShiftsDay) {
  ...
  EXPECT_THAT(RequiredTest("TimestampWithOffsetShiftsDay")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("TimestampWithOffsetShiftsDay")
...
TEST_P(JsonTimestampTest, TimestampWithOffsetBoundaryInBoundsMin) {
  ...
  EXPECT_THAT(RequiredTest("TimestampWithOffsetBoundaryInBoundsMin")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("TimestampWithOffsetBoundaryInBoundsMin")
...
TEST_P(JsonTimestampTest, TimestampWithOffsetBoundaryInBoundsMax) {
  ...
  EXPECT_THAT(RequiredTest("TimestampWithOffsetBoundaryInBoundsMax")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("TimestampWithOffsetBoundaryInBoundsMax")
...
TEST_P(JsonTimestampTest, TimestampWithComplexOffset) {
  ...
  EXPECT_THAT(RequiredTest("TimestampWithComplexOffset")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("TimestampWithComplexOffset")
