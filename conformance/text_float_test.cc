...
TEST_P(TextFloatLiteralTest, Positive) {
  ...
  EXPECT_THAT(RequiredTest(TestName("FloatField"))
...
TEST_P(TextFloatLiteralTest, Zero) {
  EXPECT_THAT(RequiredTest(TestName("FloatFieldZero"))
...
TEST_P(TextFloatLiteralTest, Negative) {
  const std::string input = Input("-3.192837");
  EXPECT_THAT(RequiredTest(TestName("FloatFieldNegative"))
                  .ParseText(message(), input)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(input))));
  EXPECT_THAT(RequiredTest(TestName("FloatFieldNegative"))
...
TEST_P(TextFloatLiteralTest, VeryPreciseNumber) {
  ...
  EXPECT_THAT(RequiredTest(TestName("FloatFieldWithVeryPreciseNumber"))
                  .ParseText(message(), input)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(input))));
  EXPECT_THAT(RequiredTest(TestName("FloatFieldWithVeryPreciseNumber"))
...
TEST_P(TextFloatLiteralTest, MaxValue) {
  ...
  EXPECT_THAT(RequiredTest(TestName("FloatFieldMaxValue"))
                  .ParseText(message(), input)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(input))));
  EXPECT_THAT(RequiredTest(TestName("FloatFieldMaxValue"))
...
TEST_P(TextFloatLiteralTest, MinValue) {
  ...
  EXPECT_THAT(RequiredTest(TestName("FloatFieldMinValue"))
                  .ParseText(message(), input)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(input))));
  EXPECT_THAT(RequiredTest(TestName("FloatFieldMinValue"))
...
TEST_P(TextFloatLiteralTest, WithInt32Max) {
  ...
  EXPECT_THAT(RequiredTest(TestName("FloatFieldWithInt32Max"))
                  .ParseText(message(), input)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(input))));
  EXPECT_THAT(RequiredTest(TestName("FloatFieldWithInt32Max"))
...
TEST_P(TextFloatLiteralTest, LargerThanInt64) {
  ...
  EXPECT_THAT(RequiredTest(TestName("FloatFieldLargerThanInt64"))
                  .ParseText(message(), input)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(input))));
  EXPECT_THAT(RequiredTest(TestName("FloatFieldLargerThanInt64"))
...
TEST_P(TextFloatLiteralTest, TooLarge) {
  ...
  EXPECT_THAT(RequiredTest(TestName("FloatFieldTooLarge"))
                  .ParseText(message(), input)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(input))));
  EXPECT_THAT(RequiredTest(TestName("FloatFieldTooLarge"))
...
TEST_P(TextFloatLiteralTest, TooSmall) {
  ...
  EXPECT_THAT(RequiredTest(TestName("FloatFieldTooSmall"))
                  .ParseText(message(), input)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(input))));
  EXPECT_THAT(RequiredTest(TestName("FloatFieldTooSmall"))
...
TEST_P(TextFloatLiteralTest, LargerThanUint64) {
  ...
  EXPECT_THAT(RequiredTest(TestName("FloatFieldLargerThanUint64"))
                  .ParseText(message(), input)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(input))));
  EXPECT_THAT(RequiredTest(TestName("FloatFieldLargerThanUint64"))
...
TEST_P(TextFloatLiteralTest, NegativeZero) {
  ...
  EXPECT_THAT(RequiredTest(TestName("FloatFieldNegativeZero"))
                  .ParseText(message(), input)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(input))));
  EXPECT_THAT(RequiredTest(TestName("FloatFieldNegativeZero"))
...
TEST_P(TextFloatLiteralTest, NoLeadingZero) {
  ...
  EXPECT_THAT(RequiredTest(TestName("FloatFieldNoLeadingZero"))
                  .ParseText(message(), input)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(input))));
  EXPECT_THAT(RequiredTest(TestName("FloatFieldNoLeadingZero"))
...
TEST_P(TextFloatLiteralTest, NegativeNoLeadingZero) {
  const std::string input = Input("-.123");
  EXPECT_THAT(RequiredTest(TestName("FloatFieldNegativeNoLeadingZero"))
                  .ParseText(message(), input)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(input))));
  EXPECT_THAT(RequiredTest(TestName("FloatFieldNegativeNoLeadingZero"))
...
TEST_P(TextFloatLiteralTest, NoLeadingZeroWithExponent) {
  ...
  EXPECT_THAT(RequiredTest(TestName("FloatFieldNoLeadingZeroWithExponent"))
                  .ParseText(message(), input)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(input))));
  EXPECT_THAT(RequiredTest(TestName("FloatFieldNoLeadingZeroWithExponent"))
...
TEST_P(TextFloatNanTest, Spelling) {
  ...
  EXPECT_THAT(RequiredTest(absl::StrCat("FloatFieldValue_", spelling()))
                  .ParseText(message(), input)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(input))));
  EXPECT_THAT(RequiredTest(absl::StrCat("FloatFieldValue_", spelling()))
...
TEST_P(TextFloatInfinityTest, Positive) {
  const std::string input = absl::StrCat("optional_float: ", spelling());
  EXPECT_THAT(RequiredTest(absl::StrCat("FloatFieldValue_Pos", spelling()))
                  .ParseText(message(), input)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(input))));
  EXPECT_THAT(RequiredTest(absl::StrCat("FloatFieldValue_Pos", spelling()))
...
TEST_P(TextFloatInfinityTest, Negative) {
  const std::string input = absl::StrCat("optional_float: -", spelling());
  EXPECT_THAT(RequiredTest(absl::StrCat("FloatFieldValue_Neg", spelling()))
                  .ParseText(message(), input)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(input))));
  EXPECT_THAT(RequiredTest(absl::StrCat("FloatFieldValue_Neg", spelling()))
...
TEST_P(TextFloatTest, NoHex) {
  EXPECT_THAT(RequiredTest("FloatFieldNoHex")
...
TEST_P(TextFloatTest, NoNegativeHex) {
  EXPECT_THAT(RequiredTest("FloatFieldNoNegativeHex")
                  .ParseText(message(), "optional_float: -0x1")
                  .ParseOnly(),
              Yields(IsParseError()));
}
...
TEST_P(TextFloatTest, NoOctal) {
  EXPECT_THAT(RequiredTest("FloatFieldNoOctal")
...
TEST_P(TextFloatTest, NoNegativeOctal) {
  EXPECT_THAT(RequiredTest("FloatFieldNoNegativeOctal")
                  .ParseText(message(), "optional_float: -012")
                  .ParseOnly(),
              Yields(IsParseError()));
}
...
TEST_P(TextFloatTest, OverflowInfinity) {
  EXPECT_THAT(RequiredTest("FloatFieldOverflowInfinity")
...
TEST_P(TextFloatTest, OverflowNegativeInfinity) {
  EXPECT_THAT(RequiredTest("FloatFieldOverflowNegativeInfinity")
                  .ParseText(message(), "optional_float: -1e50")
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto("optional_float: -inf"))));
  EXPECT_THAT(RequiredTest("FloatFieldOverflowNegativeInfinity")
...
TEST_P(TextFloatTest, OverflowInfinityHugeExponent) {
  EXPECT_THAT(
      RequiredTest("FloatFieldOverflowInfinityHugeExponent")
...
TEST_P(TextFloatTest, LargeNegativeExponentParsesAsZero) {
  EXPECT_THAT(RequiredTest("FloatFieldLargeNegativeExponentParsesAsZero")
...
TEST_P(TextFloatTest, NegativeLargeNegativeExponentParsesAsNegativeZero) {
  EXPECT_THAT(RequiredTest("NegFloatFieldLargeNegativeExponentParsesAsNegZero")
                  .ParseText(message(), "optional_float: -1e-50")
                  .SerializeBinary(),
...
TEST_P(TextDoubleTest, OverflowInfinity) {
  EXPECT_THAT(RequiredTest("DoubleFieldOverflowInfinity")
...
TEST_P(TextDoubleTest, OverflowNegativeInfinity) {
  EXPECT_THAT(RequiredTest("DoubleFieldOverflowNegativeInfinity")
                  .ParseText(message(), "optional_double: -1e9999")
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto("optional_double: -inf"))));
  EXPECT_THAT(RequiredTest("DoubleFieldOverflowNegativeInfinity")
...
TEST_P(TextDoubleTest, OverflowInfinityHugeExponent) {
  EXPECT_THAT(
      RequiredTest("DoubleFieldOverflowInfinityHugeExponent")
...
TEST_P(TextDoubleTest, LargeNegativeExponentParsesAsZero) {
  EXPECT_THAT(
      RequiredTest("DoubleFieldLargeNegativeExponentParsesAsZero")
...
TEST_P(TextDoubleTest, NegativeLargeNegativeExponentParsesAsNegativeZero) {
  EXPECT_THAT(
      RequiredTest("NegDoubleFieldLargeNegativeExponentParsesAsNegZero")
          .ParseText(message(), "optional_double: -1e-18446744073709551616")
          .SerializeBinary(),
