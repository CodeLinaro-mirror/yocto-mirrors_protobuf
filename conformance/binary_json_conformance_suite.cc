...
void BinaryAndJsonConformanceSuiteImpl<MessageType>::RunJsonTests() {
  ...
  // field tests in json_integer_test.cc, the null tests in json_null_test.cc,
  // the wrapper type tests in json_wrapper_test.cc, the unknown enum string
  // value tests in json_unknown_enum_test.cc, and the Any tests in
  // json_any_test.cc (the gtest-based suite; see BUILD).
...
void BinaryAndJsonConformanceSuiteImpl<
  ...
  // The integer field tests live in json_integer_test.cc (the gtest-based
  // suite; see BUILD).
