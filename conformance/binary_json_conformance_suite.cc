...
void BinaryAndJsonConformanceSuiteImpl<MessageType>::RunJsonTests() {
  // HelloWorld, IgnoreUnknownJson* and RejectTopLevelNull live in
  // json_hello_world_test.cc, the field name convention and
  // StoresDefaultPrimitive tests in json_field_name_test.cc, the integer
  // field tests in json_integer_test.cc, the bool, float and double field
  // tests in json_bool_test.cc and json_float_test.cc, the null tests in
  // json_null_test.cc, the wrapper type tests in json_wrapper_test.cc, the
  // Duration and Timestamp tests in json_duration_test.cc and
  // json_timestamp_test.cc, the unknown enum string value tests in
  // json_unknown_enum_test.cc, and the Any tests in json_any_test.cc (the
  // gtest-based suite; see BUILD).
...
void BinaryAndJsonConformanceSuiteImpl<
  ...
  // in json_bool_test.cc and the float and double field tests in
  // json_float_test.cc (the gtest-based suite; see BUILD).
