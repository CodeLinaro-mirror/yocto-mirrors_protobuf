        ...
        optional_any: {
          [$0] {
            optional_int32: 12345
                                                ...
                                                type_url);
  EXPECT_THAT(RequiredTest("Any").ParseJson(message(), input).SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(expected))));
  EXPECT_THAT(RequiredTest("Any").ParseJson(message(), input).SerializeJson(),
              Yields(ParsedPayload(EqualsTextProto(expected))));
}
          ...
          [type.googleapis.com/google.protobuf.Any] {
            [$0] {
              optional_int32: 12345
                                                ...
                                                type_url);
  EXPECT_THAT(
      RequiredTest("AnyNested").ParseJson(message(), input).SerializeBinary(),
      Yields(ParsedPayload(EqualsTextProto(expected))));
  EXPECT_THAT(
      RequiredTest("AnyNested").ParseJson(message(), input).SerializeJson(),
      Yields(ParsedPayload(EqualsTextProto(expected))));
}
        ...
        optional_any: {
          [$0] {
            optional_int32: 12345
                                                ...
                                                type_url);
  EXPECT_THAT(RequiredTest("AnyUnorderedTypeTag")
...
TEST_P(JsonAnyTest, AnyWithInt32ValueWrapper) {
  ...
  EXPECT_THAT(RequiredTest("AnyWithInt32ValueWrapper")
...
TEST_P(JsonAnyTest, AnyWithDuration) {
  ...
  EXPECT_THAT(RequiredTest("AnyWithDuration")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("AnyWithDuration")
...
TEST_P(JsonAnyTest, AnyWithTimestamp) {
  ...
  EXPECT_THAT(RequiredTest("AnyWithTimestamp")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("AnyWithTimestamp")
...
TEST_P(JsonAnyTest, AnyWithFieldMask) {
  ...
  EXPECT_THAT(RequiredTest("AnyWithFieldMask")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("AnyWithFieldMask")
...
TEST_P(JsonAnyTest, AnyWithStruct) {
  ...
  EXPECT_THAT(RequiredTest("AnyWithStruct")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("AnyWithStruct")
...
TEST_P(JsonAnyTest, AnyWithValueForJsonObject) {
  ...
  EXPECT_THAT(RequiredTest("AnyWithValueForJsonObject")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("AnyWithValueForJsonObject")
...
TEST_P(JsonAnyTest, AnyWithValueForInteger) {
  ...
  EXPECT_THAT(RequiredTest("AnyWithValueForInteger")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("AnyWithValueForInteger")
...
TEST_P(JsonAnyTest, AnyWktRepresentationWithEmptyTypeAndValue) {
  EXPECT_THAT(RequiredTest("AnyWktRepresentationWithEmptyTypeAndValue")
                  .ParseJson(message(), R"({
        "optionalAny": {
          "@type": "",
          "value": ""
...
TEST_P(JsonAnyTest, AnyWktRepresentationWithBadType) {
  EXPECT_THAT(RequiredTest("AnyWktRepresentationWithBadType")
                  .ParseJson(message(), R"({
        "optionalAny": {
          "@type": "not_a_url",
          "value": ""
...
TEST_P(JsonAnyTest, AnyWithNoType) {
  ...
  EXPECT_THAT(RequiredTest("AnyWithNoType")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("AnyWithNoType")
...
TEST_P(JsonAnyTest, AnyNull) {
  ...
  EXPECT_THAT(
      RequiredTest("AnyNull").ParseJson(message(), kInput).SerializeBinary(),
      Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(
      RequiredTest("AnyNull").ParseJson(message(), kInput).SerializeJson(),
      Yields(ParsedPayload(EqualsTextProto(kExpected))));
}
...
TEST_P(JsonAnyTest, AnyEmpty) {
  ...
  EXPECT_THAT(
      RequiredTest("AnyEmpty").ParseJson(message(), kInput).SerializeBinary(),
      Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(
      RequiredTest("AnyEmpty").ParseJson(message(), kInput).SerializeJson(),
      Yields(ParsedPayload(EqualsTextProto(kExpected))));
}
