...
// gMock matcher for the decoded value.  EqualsTextProto() and
// EqualsBinaryProto() are ordinary matchers on `const Message&` that are
// intended to be used inside ParsedPayload(), but work anywhere.
//
