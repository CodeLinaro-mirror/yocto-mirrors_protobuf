...
TEST_P(JsonFieldNameSerializationTest, FieldNameWithNumbersValidator) {
  EXPECT_THAT(RequiredTest("FieldNameWithNumbersValidator")
                  .ParseJson(message(), R"({
        "field0name5": 5,
        "field0Name6": 6
      })")
...
TEST_P(JsonFieldNameSerializationTest, FieldNameWithMixedCasesValidator) {
  EXPECT_THAT(
      RequiredTest("FieldNameWithMixedCasesValidator")
          .ParseJson(message(), R"({
        "fieldName7": 7,
        "FieldName8": 8,
        "fieldName9": 9,
...
TEST_P(JsonFieldNameSerializationTest,
  ...
  EXPECT_THAT(
      RecommendedTest("FieldNameWithDoubleUnderscoresValidator")
          .ParseJson(message(), R"({
        "FieldName13": 13,
        "FieldName14": 14,
        "fieldName15": 15,
