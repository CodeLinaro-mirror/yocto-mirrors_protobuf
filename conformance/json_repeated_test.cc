...
TEST_P(JsonRepeatedTest, PrimitiveRepeatedField) {
  ...
  EXPECT_THAT(RequiredTest("PrimitiveRepeatedField")
...
TEST_P(JsonRepeatedTest, EnumRepeatedField) {
  ...
  EXPECT_THAT(RequiredTest("EnumRepeatedField")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("EnumRepeatedField")
...
TEST_P(JsonRepeatedTest, StringRepeatedField) {
  ...
  EXPECT_THAT(RequiredTest("StringRepeatedField")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("StringRepeatedField")
...
TEST_P(JsonRepeatedTest, BytesRepeatedField) {
  ...
  EXPECT_THAT(RequiredTest("BytesRepeatedField")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("BytesRepeatedField")
...
TEST_P(JsonRepeatedTest, MessageRepeatedField) {
  ...
  EXPECT_THAT(RequiredTest("MessageRepeatedField")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("MessageRepeatedField")
...
TEST_P(JsonRepeatedTest,
  ...
  EXPECT_THAT(
      RequiredTest("RepeatedFieldWrongElementTypeExpectingIntegersGotBool")
...
TEST_P(JsonRepeatedTest,
  ...
  EXPECT_THAT(
      RequiredTest("RepeatedFieldWrongElementTypeExpectingIntegersGotString")
...
TEST_P(JsonRepeatedTest,
  ...
  EXPECT_THAT(
      RequiredTest("RepeatedFieldWrongElementTypeExpectingIntegersGotMessage")
...
TEST_P(JsonRepeatedTest, RepeatedFieldWrongElementTypeExpectingStringsGotInt) {
  EXPECT_THAT(
      RequiredTest("RepeatedFieldWrongElementTypeExpectingStringsGotInt")
...
TEST_P(JsonRepeatedTest, RepeatedFieldWrongElementTypeExpectingStringsGotBool) {
  EXPECT_THAT(
      RequiredTest("RepeatedFieldWrongElementTypeExpectingStringsGotBool")
...
TEST_P(JsonRepeatedTest,
  ...
  EXPECT_THAT(
      RequiredTest("RepeatedFieldWrongElementTypeExpectingStringsGotMessage")
          .ParseJson(message(),
...
TEST_P(JsonRepeatedTest, RepeatedFieldWrongElementTypeExpectingMessagesGotInt) {
  EXPECT_THAT(
      RequiredTest("RepeatedFieldWrongElementTypeExpectingMessagesGotInt")
...
TEST_P(JsonRepeatedTest,
  ...
  EXPECT_THAT(
      RequiredTest("RepeatedFieldWrongElementTypeExpectingMessagesGotBool")
          .ParseJson(message(),
...
TEST_P(JsonRepeatedTest,
  ...
  EXPECT_THAT(
      RequiredTest("RepeatedFieldWrongElementTypeExpectingMessagesGotString")
          .ParseJson(message(), R"({"repeatedNestedMessage": [{"a": 1}, "2"]})")
          .ParseOnly(),
      Yields(IsParseError()));
}
...
TEST_P(JsonRepeatedTest, SingleValueForRepeatedFieldInt32) {
  EXPECT_THAT(RequiredTest("SingleValueForRepeatedFieldInt32")
                  .ParseJson(message(), R"({"repeatedInt32": 1})")
                  .ParseOnly(),
              Yields(IsParseError()));
}
...
TEST_P(JsonRepeatedTest, SingleValueForRepeatedFieldMessage) {
  EXPECT_THAT(
      RequiredTest("SingleValueForRepeatedFieldMessage")
...
TEST_P(JsonRepeatedTest, RepeatedFieldTrailingComma) {
  EXPECT_THAT(RecommendedTest("RepeatedFieldTrailingComma")
...
TEST_P(JsonRepeatedTest, RepeatedFieldTrailingCommaWithSpace) {
  EXPECT_THAT(RecommendedTest("RepeatedFieldTrailingCommaWithSpace")
...
TEST_P(JsonRepeatedTest, RepeatedFieldTrailingCommaWithSpaceCommaSpace) {
  EXPECT_THAT(RecommendedTest("RepeatedFieldTrailingCommaWithSpaceCommaSpace")
                  .ParseJson(message(), "{\"repeatedInt32\": [1, 2, 3, 4 , ]}")
                  .ParseOnly(),
              Yields(IsParseError()));
}
...
TEST_P(JsonRepeatedTest, RepeatedFieldTrailingCommaWithNewlines) {
  EXPECT_THAT(
      RecommendedTest("RepeatedFieldTrailingCommaWithNewlines")
          .ParseJson(message(),
                     "{\"repeatedInt32\": [\n  1,\n  2,\n  3,\n  4,\n]}")
          .ParseOnly(),
      Yields(IsParseError()));
