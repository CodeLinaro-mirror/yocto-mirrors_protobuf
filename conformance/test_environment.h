...
// Creates a required test with an explicit name,
// "<Level>.<Syntax>.<Input>Input.<name>[.<Output>Output]".
// TODO: b/564135448 - remove once every suite derives its names from gtest.
internal::Test RequiredTest(absl::string_view name);

// Creates a recommended test against the global testee.  See RequiredTest().
internal::Test RecommendedTest();
internal::Test RecommendedTest(absl::string_view name);
