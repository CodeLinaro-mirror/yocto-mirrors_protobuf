...
// ran for the proto3-style message types only; the test names and the
...
TEST_P(JsonWrapperTest, OptionalBoolWrapper) {
  ...
  EXPECT_THAT(RequiredTest("OptionalBoolWrapper")
...
TEST_P(JsonWrapperTest, OptionalInt32Wrapper) {
  ...
  EXPECT_THAT(RequiredTest("OptionalInt32Wrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("OptionalInt32Wrapper")
...
TEST_P(JsonWrapperTest, OptionalUint32Wrapper) {
  ...
  EXPECT_THAT(RequiredTest("OptionalUint32Wrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("OptionalUint32Wrapper")
...
TEST_P(JsonWrapperTest, OptionalInt64Wrapper) {
  ...
  EXPECT_THAT(RequiredTest("OptionalInt64Wrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("OptionalInt64Wrapper")
...
TEST_P(JsonWrapperTest, OptionalUint64Wrapper) {
  ...
  EXPECT_THAT(RequiredTest("OptionalUint64Wrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("OptionalUint64Wrapper")
...
TEST_P(JsonWrapperTest, OptionalFloatWrapper) {
  ...
  EXPECT_THAT(RequiredTest("OptionalFloatWrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("OptionalFloatWrapper")
...
TEST_P(JsonWrapperTest, OptionalDoubleWrapper) {
  ...
  EXPECT_THAT(RequiredTest("OptionalDoubleWrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("OptionalDoubleWrapper")
...
TEST_P(JsonWrapperTest, OptionalStringWrapper) {
  ...
  EXPECT_THAT(RequiredTest("OptionalStringWrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("OptionalStringWrapper")
...
TEST_P(JsonWrapperTest, OptionalBytesWrapper) {
  ...
  EXPECT_THAT(RequiredTest("OptionalBytesWrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("OptionalBytesWrapper")
...
TEST_P(JsonWrapperTest, OptionalWrapperTypesWithNonDefaultValue) {
  ...
  EXPECT_THAT(RequiredTest("OptionalWrapperTypesWithNonDefaultValue")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("OptionalWrapperTypesWithNonDefaultValue")
...
TEST_P(JsonWrapperTest, RepeatedBoolWrapper) {
  ...
  EXPECT_THAT(RequiredTest("RepeatedBoolWrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("RepeatedBoolWrapper")
...
TEST_P(JsonWrapperTest, RepeatedInt32Wrapper) {
  ...
  EXPECT_THAT(RequiredTest("RepeatedInt32Wrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("RepeatedInt32Wrapper")
...
TEST_P(JsonWrapperTest, RepeatedUint32Wrapper) {
  ...
  EXPECT_THAT(RequiredTest("RepeatedUint32Wrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("RepeatedUint32Wrapper")
...
TEST_P(JsonWrapperTest, RepeatedInt64Wrapper) {
  ...
  EXPECT_THAT(RequiredTest("RepeatedInt64Wrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("RepeatedInt64Wrapper")
...
TEST_P(JsonWrapperTest, RepeatedUint64Wrapper) {
  ...
  EXPECT_THAT(RequiredTest("RepeatedUint64Wrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("RepeatedUint64Wrapper")
...
TEST_P(JsonWrapperTest, RepeatedFloatWrapper) {
  ...
  EXPECT_THAT(RequiredTest("RepeatedFloatWrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("RepeatedFloatWrapper")
...
TEST_P(JsonWrapperTest, RepeatedDoubleWrapper) {
  ...
  EXPECT_THAT(RequiredTest("RepeatedDoubleWrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("RepeatedDoubleWrapper")
...
TEST_P(JsonWrapperTest, RepeatedStringWrapper) {
  ...
  EXPECT_THAT(RequiredTest("RepeatedStringWrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("RepeatedStringWrapper")
...
TEST_P(JsonWrapperTest, RepeatedBytesWrapper) {
  ...
  EXPECT_THAT(RequiredTest("RepeatedBytesWrapper")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("RepeatedBytesWrapper")
...
TEST_P(JsonWrapperTest, WrapperTypesWithNullValue) {
  ...
  constexpr absl::string_view kExpected = "";
  EXPECT_THAT(RequiredTest("WrapperTypesWithNullValue")
                  .ParseJson(message(), kInput)
                  .SerializeBinary(),
              Yields(ParsedPayload(EqualsTextProto(kExpected))));
  EXPECT_THAT(RequiredTest("WrapperTypesWithNullValue")
