...
// (proto and editions flavours); the requests sent to the testee are identical
// to the legacy ones.
...
using TextPerformanceTest = MessageTypeConformanceTest;
...
// Like the legacy Int32/Int64 tests, these exercise repeated_uint32 and
// repeated_uint64.
