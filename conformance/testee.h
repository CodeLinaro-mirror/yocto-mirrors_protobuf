...
// test (see RequiredTest() in test_environment.h).  The full name is
//
...
class Test {
 ...
 private:
  Test(class Testee* testee, TestName name, TestStrictness strictness)
      : testee_(testee), name_(std::move(name)), strictness_(strictness) {}
  friend class Testee;
